...
export default function CardTypeDetail() {
    ...
    <div style={{ maxWidth: "768px", margin: "auto", padding: "2rem" }}>
      ...
      >
        ...
        <div style={{ marginBottom: "1rem" }}>
          <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
            <li style={{ marginBottom: "0.5rem" }}>
              <strong>Name: </strong> {cardType.name}
            </li>
            <li style={{ marginBottom: "0.5rem" }}>
              <strong>Description: </strong>{" "}
              {cardType.description || "No description provided"}
            </li>
            <li style={{ marginBottom: "0.5rem" }}>
              <strong>Creation Date: </strong> {formatDate(cardType.createdAt)}
            </li>
            <li style={{ marginBottom: "0.5rem" }}>
              <strong>Last Modified: </strong> {formatDate(cardType.updatedAt)}
            </li>
          </ul>
        </div>
        ...
        >
          ...
          <Button
            onClick={() => router.push(`/dashboard/ref/card-types/${id}/edit`)}
            themeColor="primary"
          >
            Edit
          </Button>
