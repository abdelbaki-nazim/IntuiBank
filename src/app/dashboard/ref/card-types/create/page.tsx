...
export default function CreateCardType() {
  ...
  const handleSubmit = async (data: any) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setError(result.error || "Error creating card type");
      }
    } catch (err) {
      setError("Error creating card type");
    } finally {
  ...
  return (
    <div style={{ maxWidth: "768px", margin: "auto", padding: "2rem" }}>
      <Typography.h4>Create Card Type</Typography.h4>
      <Form
