...
export default function GuaranteeTypeEdit() {
  ...
  const handleSubmit = async (data: any) => {
    ...
    try {
      const response = await fetch(`/api/guarantee-types/${id}`, {
        method: "PUT",
      ...
      if (result.error) {
        ...
        router.push("/dashboard/ref/guarantee-types");
      }
    } catch (err) {
